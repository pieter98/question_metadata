...
===================================================================================================================
'''
def separate_data(dir_path, dest_path):
    dirs = [dir_path]
    while len(dirs) > 0:
...
helper method for language separation
...
'''
# Example usage
src = os.path.join(os.getcwd(), "Questions")
dest = os.path.join(os.getcwd(), "Language Seperated Questions")
dirs = os.listdir(src)
separate_data(src, dest)
'''